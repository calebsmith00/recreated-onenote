...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const testUrl =
    "https://login.microsoftonline.com/organizations/oauth2/v2.0/authorize?client_id=f2e346d7-bfb2-4cb6-ad65-dc69d6f2cbc8&response_type=code&redirect_uri=http://localhost:3000&response_mode=query&scope=user.read.all&code_challenge=7BtZpqFs_Bq9OMamb4NKdjBjI8huQEyzXagBoldMRG0&code_challenge_method=S256";

  return {
    props: { authorizeURL: testUrl },
  };
};
